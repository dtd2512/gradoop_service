...
public class CytoJSONBuilder {
     ...
     */
    public static String getJSON(GraphHead graphHead, List<Vertex> vertices, List<Edge> edges) throws JSONException {
     ...
     */
    public static String getJSON(JSONObject graph, JSONArray vertices, JSONArray edges) throws
            JSONException {
